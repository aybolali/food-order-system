...
public class OrderKafkaMessageHelper{
    public <T> ListenableFutureCallback<SendResult<String, T>> getKafkaCallback(String responseTopicName,
                                                                                T typeOfRequestAvroModel, //RestaurantApprovalRequestAvroModel, PaymentRequestAvroModel
        ...
        return new ListenableFutureCallback<SendResult<String, T>>() {
            ...
            public void onFailure(Throwable ex) {
                log.error("Error while sending " + requestAvroModelName +
                        " message {} to topic {}", typeOfRequestAvroModel.toString(), responseTopicName, ex);
            }
