...
@Component
public class OrderOutboxPaymentRepositoryImpl implements OrderOutboxPaymentRepository {

    private final OrderOutboxJpaRepository orderOutboxJpaRepository;
    private final OrderOutboxDataAccessMapper orderOutboxDataAccessMapper;

    public OrderOutboxPaymentRepositoryImpl(OrderOutboxJpaRepository orderOutboxJpaRepository,
