...
import com.food.ordering.system.domain.exception.PaymentNotFoundException;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public PaymentRequestKafkaListener(PaymentMessagingDataMapper paymentMessagingDataMapper, PaymentRequestMessageListener listener) {
        this.paymentMessagingDataMapper = paymentMessagingDataMapper;
        this.paymentRequestMessageListener = listener;
    }
